...
import me.storm.volley.data.BitmapLruCache;
...
public class MyVolley extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.my_activity_image_volley);
		initView();
	}
		...
		ImageRequest imageRequest = new ImageRequest(imageUrl1,
				new Listener<Bitmap>() {
					...
					public void onResponse(Bitmap response) {
						Log.i("llb", "bitmap height" + response.getHeight()
	...
	private void requestByNetworkImageView() {
		...
		netIV_volley.setErrorImageResId(android.R.drawable.ic_input_delete);// 出错时的图片
		// public ImageContainer get(String requestUrl, final ImageListener
		// listener) {
